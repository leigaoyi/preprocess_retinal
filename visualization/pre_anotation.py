...
for i in range(6):
    ...
    axes[1, i].imshow(gray_median, cmap='gray')
    axes[2, i].imshow(gray_clahe, cmap='gray')
axes[0, 0].set_ylabel('Gray img', size='large')    
axes[1, 0].set_ylabel('Median filter', size='large')
axes[2, 0].set_ylabel('CLAHE', size='large')
plt.savefig('Anotation.png', format='png', dpi=300)
plt.show()
#plt.clf()
